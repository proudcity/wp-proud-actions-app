...
$rootScope.currentYPosition()<300&&$("html, body").animate({scrollTop:$("#wrapper-311").offset().top-70},300),toggleMain($scope.mainToggle,$scope.mainToggleForce,select)})}}}).directive("menuClick",function($window,$browser){return{restrict:"A",link:function($scope,$element,$attrs){$element.on("click",function(event){return jQuery(".app-wrap").toggleClass("show-nav"),$attrs.menuClick&&"return-false"==$attrs.menuClick?(event.stopPropagation(),!1):void 0})}}}).directive("href",function($rootScope){return{compile:function(element){return{post:function(scope,element,attributes,controller,transcludeFn){if($rootScope.externalLinkWindow){var a=new RegExp("/"+window.location.host+"/"),href=element.attr("href");console.log(href),void 0!=href&&href&&!a.test(href)&&(console.log(href),element.attr("target","_blank"))}}}}}}),angular.module("311App").provider("Menu311",function(){
// Init Proud   
