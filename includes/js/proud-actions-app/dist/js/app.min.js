...
keywords:"About, this, page",// Sets different meta keywords,
doScroll:!1,// no scroll on route change
undoMainToggle:!0},controller:function($scope,$rootScope,$state,$filter,data){$scope.contests=$filter("filter")(data.contests,{type:"General"}).slice().reverse(),$scope.googleSearch=function(name,loc,$e){$e.preventDefault(),console.log(name),window.open("//google.com/search?q="+encodeURIComponent(name))}}})}])}(jQuery);