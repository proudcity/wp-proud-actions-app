...
console.log(JSON.stringify(data)),$http.post($rootScope.seeclickfixUrl+"issues",data).then(function(response){console.log(response)},function(response){})}}})}]),angular.module("311App").config(["$stateProvider","$urlRouterProvider",function($stateProvider,$urlRouterProvider){$stateProvider.state("city.payments",{templateUrl:"views/apps/311App/payment/payment.html",data:{doScroll:!1,// No scroll on route change
undoMainToggle:!0,// Force "offcanvas" class off
