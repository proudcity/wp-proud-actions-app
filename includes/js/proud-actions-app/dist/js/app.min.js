...
$rootScope.trackUrl=_.get(Proud,"settings.proud_actions_app.global.track_url")||"http://markaspot.helmcivic.com/georeport/v2",$rootScope.googleKey=_.get(Proud,"settings.proud_actions_app.global.google_key")||"",$rootScope.googleElectionId=_.get(Proud,"settings.proud_actions_app.global.google_election_id")||"2000",
// Global options
// ---------------------------
...
// Get myIssues
$scope.hasMyIssues=!1;var local=localStorage.getItem("reportedIssues");-1===local&&($scope.hasMyIssues=-1),local&&-1!==local&&($scope.myIssues=JSON.parse(local),$scope.activeTab="me",$scope.hasMyIssues=!0),
// Get recent issues
