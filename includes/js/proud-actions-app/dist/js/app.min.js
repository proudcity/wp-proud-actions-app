...
var categories=_.get(Proud,"settings.proud_311_app."+$rootScope.appId+".category_section")||{health:"health","jobs-contracts":"jobs-contracts",payments:"payments","permits-licensing":"0","property-housing":"0",services:"0",transportation:"transportation"};categories=_.transform(_.values(categories),function(res,v,k){v&&"0"!==v&&res.push(v)}),$rootScope.categories=categories}}}),angular.module("311App").directive("menu",function($rootScope,Menu311,$state){return{restrict:"A",templateUrl:"views/apps/311App/menu311.html",link:function($scope,$element,$attrs){
// Push to scope
